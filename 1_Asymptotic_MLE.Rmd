---
title: "Lab: Large Sample Normal Approximation to the Sampling Distribution of the MLE"
output:
  pdf_document:
    keep_tex: true
header-includes:
...
Previously, you obtained a normal approximation to the sampling distribution of the maximum likelihood estimator for a Pareto distribution.  This normal approximation is approximately valid if the sample size is large enough.
...
4. For i in 1, ..., n_sims:
    ...
    c. Find the maximum likelihood estimate and save it in the results data frame from step 3
